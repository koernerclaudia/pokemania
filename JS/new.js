...
let modal = (function () {
    ...
    function showModal(title, text, text2, img) {
      ...
      // define the modal title to be H1
  ...
  let pokemonAPI = (function () {
    ...
    function loadDetails(item) {
      ...
      return fetch(url).then(function (response) {
       ...
       modal.showModal('Pokemon: ' + capitalizeFirstLetter(item.name), 'Height: ' + details.height + '0 cm', 'Weight: ' + details.weight + 'kg', details.sprites.front_default);
    }).catch(function (e) {
        console.error(e);
    });
}
